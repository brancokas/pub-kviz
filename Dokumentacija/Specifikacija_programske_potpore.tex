	...
	\section{Funkcionalni zahtjevi}
			...
			\subsection{Obrasci uporabe}
				...
				\begin{packed_item}
					...
					\item \textbf{Glavni sudionik:} Korisnik (Sastavljač kviza)
				...
				\begin{packed_item}
					...
					\item \textbf{Glavni sudionik:} Korisnik (Igrač)
				...
				\noindent \underbar{\textbf{UC$$13$$ - $$Pregled reduciranih detalja objavljenog događaja$$}}
				\begin{packed_item}
				...
				\noindent \underbar{\textbf{UC$$14$$ - $$Pretraživanje objavljenih događaja$$}}
				\begin{packed_item}
				...
				\noindent \underbar{\textbf{UC$$15$$ - $$Filtriranje objavljenih događaja$$}}
				\begin{packed_item}
				...
				\noindent \underbar{\textbf{UC$$16$$ - $$Pronalazak ekipe za kviz$$}}
				\begin{packed_item}
				...
				\noindent \underbar{\textbf{UC$$17$$ - $$Pregled obavijesti o pronađenoj ekipi$$}}
				\begin{packed_item}
				...
				\noindent \underbar{\textbf{UC$$18$$ - $$Pregled obavijesti o novom članu ekipe$$}}
				\begin{packed_item}
				...
				\noindent \underbar{\textbf{UC$$19$$ - $$Napuštanje ekipe$$}}
				\begin{packed_item}
				...
				\noindent \underbar{\textbf{UC$$20$$ - $$Pregled obavijesti o napuštanju člana ekipe$$}}
				\begin{packed_item}
				...
				\noindent \underbar{\textbf{UC$$21$$ - $$Prijava ekipe na događaj$$}}
				\begin{packed_item}
				...
				\noindent \underbar{\textbf{UC$$22$$ - $$Pregled obavijesti o prijavi na događaj$$}}
				\begin{packed_item}
				...
				\noindent \underbar{\textbf{UC$$23$$ - $$Blokiranje korisnika$$}}
				\begin{packed_item}
				...
				\noindent \underbar{\textbf{UC$$24$$ - $$Brisanje objavljenih događaja$$}}
				\begin{packed_item}
				...
				\noindent \underbar{\textbf{UC$$25$$ - $$Dodjela administratorskih prava korisniku$$}}
				\begin{packed_item}
				...
				\noindent \underbar{\textbf{UC$$26$$ - $$Pregled profila sastavljača$$}}
				\begin{packed_item}
				...
				\noindent \underbar{\textbf{UC$$27$$ - $$Pregled statistike$$}}
				\begin{packed_item}
